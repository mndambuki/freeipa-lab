resource "tls_private_key" "freeipa_master_pkinit" {
  algorithm = "RSA"
  rsa_bits  = 4096
}

resource "tls_cert_request" "freeipa_master_pkinit" {
  private_key_pem = tls_private_key.freeipa_master_pkinit.private_key_pem
  key_algorithm   = tls_private_key.freeipa_master_pkinit.algorithm
